...
The custom action `labmtl/env/.github/actions/setup-nix-env@main` automatically configures the cache using the public bucket URL and the public signing key.
